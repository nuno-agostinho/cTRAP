...
cmapGeneInfo <- laodCMapData("cmapGeneInfo.txt", "geneInfo")
...
# Compare against CMap using gene set enrichment analysis (GSEA) with the top
...
# Compare against CMap using Spearman correlation
compareSmallMolecule$spearman <- compareAgainstCMap(
    diffExprStat, cmapPerturbationsSmallMolecules, cellLine, method="spearman")

# Compare against CMap using Pearson correlation
compareSmallMolecule$pearson <- compareAgainstCMap(
    diffExprStat, cmapPerturbationsSmallMolecules, cellLine, method="pearson")

# Compare against CMap using gene set enrichment analysis (GSEA) with the top
# and bottom 150 genes
compareSmallMolecule$gsea <- compareAgainstCMap(
    diffExprStat, cmapPerturbationsSmallMolecules, cellLine, method="gsea",
    geneSize=150)
```
