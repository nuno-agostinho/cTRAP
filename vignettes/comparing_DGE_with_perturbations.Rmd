...
([Subramanian et al., Cell 2017][subramanian2017]). Such analyses allow not only
to infer the molecular causes of the observed difference in gene expression but
also to identify small molecules that could drive or revert specific
...
plotL1000comparison(compareKnockdown$spearman, 
                    tail(compareKnockdown$spearman, 1)$genes)
plotL1000comparison(compareKnockdown$pearson, 
                    tail(compareKnockdown$pearson, 1)$genes)
plotL1000comparison(compareKnockdown$gsea,
                    tail(compareKnockdown$gsea, 1)$genes)
```
...
plotL1000comparison(compareSmallMolecule$spearman,
                    head(compareSmallMolecule$spearman, 1)$compounds)
plotL1000comparison(compareSmallMolecule$pearson,
                    head(compareSmallMolecule$pearson, 1)$compounds)
plotL1000comparison(compareSmallMolecule$gsea,
                    head(compareSmallMolecule$gsea, 1)$compounds)

# Plot relationship with most negatively associated perturbation
plotL1000comparison(compareSmallMolecule$spearman,
                    tail(compareSmallMolecule$spearman, 1)$compounds)
plotL1000comparison(compareSmallMolecule$pearson,
                    tail(compareSmallMolecule$pearson, 1)$compounds)
plotL1000comparison(compareSmallMolecule$gsea,
                    tail(compareSmallMolecule$gsea, 1)$compounds)
```
