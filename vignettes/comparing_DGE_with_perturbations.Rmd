...
plot(cmapPerturbationsCompounds, 
     head(compareCompounds[order(spearman_coef_rank)], 1), diffExprStat,
     "spearman")
plot(cmapPerturbationsCompounds,
     head(compareCompounds[order(pearson_coef_rank)], 1), diffExprStat, 
     "pearson")
plot(cmapPerturbationsCompounds, 
     head(compareCompounds[order(WTCS_rank)], 1), diffExprStat, "gsea")

# Plot relationship with most negatively associated perturbation
plot(cmapPerturbationsCompounds,
     tail(compareCompounds[order(spearman_coef_rank)], 1), diffExprStat, 
     "spearman")
plot(cmapPerturbationsCompounds, 
     tail(compareCompounds[order(pearson_coef_rank)], 1), diffExprStat,
     "pearson")
plot(cmapPerturbationsCompounds, 
     tail(compareCompounds[order(WTCS_rank)], 1), diffExprStat, "gsea")
```
