...
> Compounds are ranked by their relative targeting potential (i.e. the 
1st-ranked compound has higher targeting potential than the 2nd-ranked one).
...
plotTargetingDrugsVSsimilarPerturbations(
  predicted, compareCompounds, column="spearman_rank", labelColumn="target")
# Label by compound's mechanism of action (MOA)
plotTargetingDrugsVSsimilarPerturbations(
  predicted, compareCompounds, column="spearman_rank", labelColumn="moa")
```
...
drugSets    <- prepareDrugSets(descriptors, "NSC number")
