...
forget to use the same filename as the argument of
...
plot(compareKD, method="spearman", n=c(10, 3))
plot(compareKD, method="pearson")
plot(compareKD, method="gsea")
plot(compareKD, method="rankProduct")
```
...
plot(compareCompounds, method="rankProduct")
```
...
# Spearman's correlation)
print(compareKD[order(rankProduct_rank, na.last=NA)], 1:10)
