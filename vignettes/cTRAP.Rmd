...
>
> Alternatively, download the file from the following link (use the exact same
filename for the `zscores` argument of `prepareCMapPerturbations()`):
[GSE92742_Broad_LINCS_Level5_COMPZ.MODZ_n473647x12328.gctx.gz][zscores]
([SHA-512 checksum][checksums])

[zscores]: ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742_Broad_LINCS_Level5_COMPZ.MODZ_n473647x12328.gctx.gz
[checksums]: ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742_SHA512SUMS.txt.gz
